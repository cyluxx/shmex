...
describe('decomposeAsc', () => {
  ...
  it('decomposes 7/8 to [1/8, 1/4, 1/2]', () => {
    expect(decomposeAsc(new Fraction(7, 8))).toEqual([
      new Fraction(1, 8),
      new Fraction(1, 4),
      new Fraction(1, 2)
    ]);
  ...
  it('decomposes 5/8 to [1/8, 1/2]', () => {
    expect(decomposeAsc(new Fraction(5, 8))).toEqual([
      new Fraction(1, 8),
      new Fraction(1, 2)
    ]);
  });
...
describe('decomposeDesc', () => {
  ...
  it('decomposes 7/8 to [1/2, 1/4, 1/8]', () => {
    expect(decomposeDesc(new Fraction(7, 8))).toEqual([
      new Fraction(1, 2),
      new Fraction(1, 4),
      new Fraction(1, 8)
    ]);
  ...
  it('decomposes 5/8 to [1/2, 1/8]', () => {
    expect(decomposeDesc(new Fraction(5, 8))).toEqual([
      new Fraction(1, 2),
      new Fraction(1, 8)
    ]);
  });
